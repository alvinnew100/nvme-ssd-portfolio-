    ...
    <SectionWrapper className="py-24 px-4 bg-story-surface">
      <div className="max-w-4xl mx-auto">
        ...
        <RevealCard
          ...
          options={["Filesystem choice does not matter for SSDs since the FTL abstracts away all filesystem differences", "TRIM support and write patterns and journaling overhead and alignment all affect SSD wear and GC efficiency and performance differently across filesystems", "Only the TRIM setting matters since all modern filesystems have identical write patterns on SSDs", "Filesystems are irrelevant since the NVMe driver handles all optimization between the OS and the SSD"]}
          correctIndex={1}
        />
