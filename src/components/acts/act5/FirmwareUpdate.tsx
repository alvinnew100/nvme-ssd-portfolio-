    ...
    <SectionWrapper className="py-24 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <RevealCard
          ...
          options={["Use CA3 immediate activation on all 1000 drives simultaneously for fastest deployment", "Use CA1 download plus activate on reset and stage to slot 2 while keeping working firmware in slot 1 as rollback then reset in rolling batches", "Download the firmware and let the SSD auto-activate during its next idle period", "Firmware updates are atomic so no rollback plan is needed since they either fully succeed or fully fail"]}
          correctIndex={1}
        />
      </div>
    </SectionWrapper>
