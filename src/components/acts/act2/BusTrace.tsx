    ...
    <SectionWrapper className="py-24 px-4 bg-story-surface">
      <div className="max-w-4xl mx-auto">
        ...
        <RevealCard
          ...
          options={["Separate types exist only for debugging visibility — internally they use the same TLP format", "DMA Writes are posted (fire-and-forget) while DMA Reads are split transactions requiring a completion response — without both, the SSD could not fetch commands from and deliver data to host RAM", "Reads and writes use the same TLP type but different priority levels in the PCIe arbiter", "The separation is a legacy PCIe 1.0 requirement that modern Gen 4/5 hardware no longer needs"]}
          correctIndex={1}
        />
      </div>
    </SectionWrapper>
