    ...
    <SectionWrapper className="py-24 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <RevealCard
          ...
          options={["Format NVM is sufficient — it performs a full block erase of every NAND cell on the drive", "Format NVM only resets logical mappings and data may persist in NAND; use Sanitize with Crypto Erase or Block Erase to make data unrecoverable across all areas including over-provisioned space", "Neither is needed — simply deleting the partition table makes data unrecoverable", "Format NVM is fine for financial data as long as you run it three times in succession"]}
          correctIndex={1}
        />
      </div>
    </SectionWrapper>
