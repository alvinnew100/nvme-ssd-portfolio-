    ...
    <SectionWrapper className="py-24 px-4 bg-story-surface">
      <div className="max-w-4xl mx-auto">
        ...
        <RevealCard
          ...
          options={["The drive uses parallel NAND erase across all dies simultaneously which completes in under a second", "Crypto erase destroys the Data Encryption Key — since all NAND data was encrypted with that key destroying it makes everything unrecoverable without touching the NAND cells", "The drive only marks blocks as erased in its metadata table without actually erasing the NAND cells", "4 TB can be erased in under one second because modern NAND supports microsecond-level block erase operations"]}
          correctIndex={1}
        />
      </div>
    </SectionWrapper>
