    ...
    <SectionWrapper className="py-24 px-4 bg-story-surface">
      <div className="max-w-4xl mx-auto">
        ...
        <RevealCard
          ...
          options={["Software overhead is truly irrelevant — NAND physics is always the bottleneck regardless of queue depth", "At high queue depths SSD internal parallelism hides NAND latency, making software overhead the new bottleneck — io_uring and SPDK reduce this", "io_uring and SPDK speed up the NAND reads themselves by using more efficient DMA patterns", "These optimizations only matter for writes; read latency is purely NAND-limited at all queue depths"]}
          correctIndex={1}
        />
      </div>
    </SectionWrapper>
