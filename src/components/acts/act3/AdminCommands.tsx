    ...
    <SectionWrapper className="py-24 px-4 bg-story-surface">
      <div className="max-w-4xl mx-auto">
        ...
        <RevealCard
          ...
          options={["Admin commands run on the host CPU while I/O commands run on the SSD controller", "They share a queue internally — the separation is just a software abstraction in the driver", "Separate queues ensure management commands are never starved by heavy I/O traffic, providing a guaranteed-responsive control channel", "Admin commands require encryption that I/O commands do not, necessitating different queue hardware"]}
          correctIndex={2}
        />
      </div>
    </SectionWrapper>
