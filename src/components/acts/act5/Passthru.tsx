...
nvme admin-passthru /dev/nvme0 \\
  ...
  -w --input-file=/tmp/config.bin`}
        ...
        <RevealCard
          ...
          options={["The reserved ranges are unused placeholders since vendors have not implemented custom commands yet", "Standardizing would be faster but the NVMe committee has not had time to define all possible commands", "Reserved opcode ranges let vendors implement proprietary diagnostics and tuning without exposing internal architecture or waiting for the standards process", "Vendor-specific commands are deprecated in NVMe 2.0 and all commands will be standardized"]}
          correctIndex={2}
        />
      </div>
    </SectionWrapper>
