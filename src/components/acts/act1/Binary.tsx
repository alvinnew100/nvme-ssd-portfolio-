    ...
    <SectionWrapper className="py-24 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <RevealCard
          ...
          options={[
            "178 — positional weights are powers of 2: 128+32+16+2",
            "182 — by adding each digit's face value times its position number",
            "194 — each bit represents a power of 10 in binary notation",
            "162 — calculated by summing the positions of the 1-bits starting from position 1"
          ]}
          correctIndex={0}
        />
        ...
        <RevealCard
          ...
          options={[
            "It's an arbitrary industry convention chosen for marketing reasons",
            "1,024 = 2^10, which matches how binary address lines double addressable space — 10 address lines = 1,024 addresses",
            "It accounts for 24 bytes of error-correction overhead per 1,000 data bytes",
            "The original IBM specification rounded 1,000 up to the nearest byte boundary"
          ]}
          correctIndex={1}
        />
      </div>
