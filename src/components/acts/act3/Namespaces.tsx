    ...
    <SectionWrapper className="py-24 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <RevealCard
          ...
          options={["Namespaces provide hardware-level isolation with independent LBA ranges, separate format settings, and protocol-enforced access boundaries that partitions cannot offer", "Namespaces are just a naming convention — partitions and namespaces provide identical isolation", "Partitions are limited to 4 per drive while namespaces support up to 65,535", "Namespaces only matter for NVMe-oF (fabrics); for local drives partitions are equivalent"]}
          correctIndex={0}
        />
      </div>
    </SectionWrapper>
